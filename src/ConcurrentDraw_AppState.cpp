...
void InitAppState (void)
	...
	appState.cdPolymorphColors[4].rgbRed = appState.cdPolymorphColors[4].rgbGreen = appState.cdPolymorphColors[4].rgbBlue = 255;
	appState.cdPolymorphColors[0].rgbRed = appState.cdPolymorphColors[0].rgbGreen = appState.cdPolymorphColors[0].rgbBlue = 0;
